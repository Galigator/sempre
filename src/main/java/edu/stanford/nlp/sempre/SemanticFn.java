...
/**
 * A semantic function takes a sequence of child derivations and produces a set of parent derivations. This is a pretty general concept, which can be used to: -
 * Generating candidates (lexicon) - Do simple combination - Filtering of derivations To override implement this function, you just need to fill out the call()
 * function.
 *
 * @author Percy Liang
 */
