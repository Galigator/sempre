...
/**
 * A TypeLookup object handles the domain-specific part of type inference. TypeInference handles the domain general part. Given an entity or a property, return
 * the appropriate SemType.
 */
