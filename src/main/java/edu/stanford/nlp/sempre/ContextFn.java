 ...
 * and forbiddenTypes arguments allowing you to specify the depth/size and type of (formula) subtrees that you want to extract from the context. ONLY USE WITH
 * TYPES!! E.g., (rule $X (context) (ContextFn (depth 0) (type fb:type.any)) would extract any unary/entity. (rule $X (context) (ContextFn (depth 1) (type (->
 * fb:type.any fb:type.any)) (forbidden (-> fb:type.any fb:type.something)) would extract all binaries except those with arg1 of type fb:type.something
 *
