...
public abstract class TypeHint
{
	...
	/**
	 * Immutable map from variable name to its value. At most one variable can be a free variable. The scope (domain) of the free variable can also be specified
	 * as a formula.
	 */
