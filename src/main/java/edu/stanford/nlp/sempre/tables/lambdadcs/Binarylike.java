...
/**
 * Represents a BinaryDenotation. By LambdaDCS convention, (v <= k) means that k maps to v. The following operations must be handled: - Reverse - reverse(BL) -
 * Compose - Join: BL.UL - Superlative: argmax(UL, BL), ...
 *
 * @author ppasupat
 */
