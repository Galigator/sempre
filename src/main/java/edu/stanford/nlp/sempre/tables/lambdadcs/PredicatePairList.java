 ...
 * (: u) is an empty unary if u is empty; STAR otherwise. - EQUAL: identity map
 * 
 * @author ppasupat
 */
public class PredicatePairList implements PairList
{
	...
	public UnaryDenotation inverseGet(Value value)
	{
		switch (type)
		{
			...
			case COMPARISON:
				return new InfiniteUnaryDenotation.ComparisonUnaryDenotation(CanonicalNames.COMPARATOR_REVERSE.get(predicateId), value);
			default:
