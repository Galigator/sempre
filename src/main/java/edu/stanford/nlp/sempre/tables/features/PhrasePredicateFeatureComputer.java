...
public class PhrasePredicateFeatureComputer implements FeatureComputer
{
	...
	private void extractMatch(Example ex, Derivation deriv, PhraseInfo phraseInfo, String phraseString, String phraseType, PredicateInfo predicateInfo, String predicateString, String predicateType, double factor)
	{
	...
	private void defineFeatures(Example ex, Derivation deriv, PhraseInfo phraseInfo, PredicateInfo predicateInfo, String featurePrefix, String phraseString, String predicateString, double factor)
	{
	...
	private void defineFeatures(Example ex, Derivation deriv, PhraseInfo phraseInfo, PredicateInfo predicateInfo, String featurePrefix, double factor)
	{
		if (opts.verbose >= 2)
