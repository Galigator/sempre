	...
	public DerivationStream call(final Example ex, final Callable c)
	{
		return new SingleDerivationStream()
		{
			...
			public Derivation createDerivation()
			{
				...
				final Derivation child0 = c.child(0);
				final Derivation child1 = c.child(1);
				final SemType type = child0.type.meet(child1.type);
				...
				final Derivation deriv = new Derivation.Builder().withCallable(c).formula(result).type(type).localFeatureVector(features).createDerivation();
