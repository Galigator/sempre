...
public final class TokenLevelMatchFeatures
{
	...
	public static int diffSetSize(String query, String answer)
	{
		...
		if (queryContains) { return queryTokens.length - answerTokens.length; }
	...
	private static int findLongestMatch(List<String> source, List<String> target, int i, int j, boolean strict)
	{
