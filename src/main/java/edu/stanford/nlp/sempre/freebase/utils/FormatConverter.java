...
public final class FormatConverter
{
	...
	/**
	 * convert from <b>[/award/award_winning_work/awards_won, /award/award_honor/award_winner]</b> to <b>(lambda x (fb:award.award_winning_work.awards_won
	 * (fb:award.award_honor.award_winner (var x))))</b>
	 */
