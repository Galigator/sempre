...
public final class UnaryLexicon
{
	...
	private void addEntry(String nl, String source, Formula formula, Map<String, Double> featureMap)
	{
		...
		if (ffi.getUnaryInfo(formula) != null)
		{
			...
			UnaryLexicalEntry uEntry = new UnaryLexicalEntry(nl, nl, new TreeSet<>(uInfo.descriptions), formula, EntrySource.parseSourceDesc(source), uInfo.popularity, new TreeMap<>(featureMap), uInfo.types);
