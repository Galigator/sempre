...
class InteractiveBeamParserState extends ChartParserState
{
	...
	public InteractiveBeamParserState(InteractiveBeamParser parser, Params params, Example ex, boolean computeExpectedCounts, Mode mode, InteractiveBeamParserState coarseState)
	{
