...
public class ErrorValue extends Value
{
	...
	public static final ErrorValue badFormula(final BadFormulaException e)
	{
	...
	public static final ErrorValue badJava(final String message)
	{
	...
	public ErrorValue(final LispTree tree)
	{
	...
	public static ErrorValue fromString(final String s)
	{
		if (s.equals(timeout.type))
			return timeout;
		if (s.equals(server408.type))
			return server408;
		if (s.equals(server500.type))
			return server500;
		if (s.equals(empty.type))
			return empty;
		if (s.equals(badFormat.type))
			return badFormat;
		return null;
	}
	...
	public boolean equals(final Object o)
	{
		...
		if (o == null || getClass() != o.getClass())
			return false;
		final ErrorValue that = (ErrorValue) o;
