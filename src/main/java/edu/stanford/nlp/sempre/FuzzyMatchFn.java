...
public class FuzzyMatchFn extends SemanticFn
{
	...
	{
		UNARY, BINARY, ENTITY, ORDER_BEFORE, ORDER_AFTER, ORDER_NEXT, ORDER_PREV, ORDER_ADJACENT
	};
	...
	public FuzzyMatchFnMode getMode()
	{
		return mode;
	}
	...
	public static class LazyFuzzyMatchFnDerivs extends MultipleDerivationStream
	{
		...
		public Derivation createDerivation()
		{
			...
			return new Derivation.Builder().withCallable(c).formula(formula).type(type).localFeatureVector(features).createDerivation();
		}
