...
/**
 * Used to prune formulas during parsing. Extend this class to add custom pruning criteria, then add the class name to the |pruningComputers| options of
 * DerivationPruner.
 *
 * @author ppasupat
 */
public abstract class DerivationPruningComputer
{
	...
	/**
	 * Prune the derivation. To add pruning strategies, override this method. Return the strategy name to prune the formula, and null otherwise.
	 */
