...
/**
 * Created by joberant on 2/24/15. This converts (targetValue (list (name fb:en.place.walton_county))) to (targetValue (string [(name
 * fb:en.place.walton_county)])) This has nothing to do with 'paraphrase', it's just here for no reason
 */
