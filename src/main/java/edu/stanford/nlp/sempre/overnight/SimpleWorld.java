...
public final class SimpleWorld
{
	...
	public static String ensureNumericProperty(String property)
	{
		createWorld();
		String type2 = propertyToType2.get(property);
		if (type2.endsWith("number") || type2.equals("en.date") || type2.equals("en.time")) { return property; }
	...
	public static List<Value> ensureNumericEntity(List<Value> list)
	{
		...
		if (type.endsWith("number") || type.equals("en.date") || type.equals("en.time")) { return list; }
	...
	public static List<Value> filter(List<Value> entities, String property)
	{ // Unary properties
	...
	private static void insertDB(Value e1, String property)
